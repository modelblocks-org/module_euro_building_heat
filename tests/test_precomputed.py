...
@pytest.mark.parametrize(
    ("path", "value"),
    [
        (("heat", "spatial_weights", "population", "share"), 0.6),
        (("heat", "spatial_weights", "age", "enabled"), False),
        (("buildings_eubucco", "version"), "0.3"),
        (("buildings_microsoft", "minimum_building_count"), 3000),
        (("population", "epoch"), 2020),
        (("raster", "cell_size_m"), 200),
        (("eurostat", "useful_to_gross_ratio"), 1.3),
        (("processing", "intermediate_dtype"), "float32"),
...
def test_downstream_and_execution_settings_reuse(settings):
    ...
    config["population"]["chunk_size"] = 128
    config["processing"]["nuts3_batches"] = 1
    config["heat"]["hdd"]["elasticity"] = 0
    config["heat"]["heat_pump"]["correction_factor"] = 0.9
